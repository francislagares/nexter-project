...
module.exports = merge(common, {
  ...
  devServer: {
    contentBase: 'dist',
    // Tells dev-server to open specified browser after server had been started.
    // Alternatively you can provide more option flags like '--incognito' for example and so on.
    open: {
      app: ['firefox']
    },
